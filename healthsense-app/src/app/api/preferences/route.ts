...
export async function POST(request: Request) {
  try {
    ...
    const payload = {
      ...
      home_pillar_reflection: body.home_pillar_reflection ?? undefined,
      home_pillar_purpose: body.home_pillar_purpose ?? undefined,
      home_pillar_resilience: body.home_pillar_resilience ?? undefined,
