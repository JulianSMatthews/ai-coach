  ...
  return (
    ...
    >
      <section className="space-y-2">
        <h2 className="text-xl text-[var(--text-primary)]">Coaching, not medical care</h2>
        <p>
      ...
      <section className="space-y-2">
        <h2 className="text-xl text-[var(--text-primary)]">Using health and urine test information</h2>
        <p>
      ...
      <section className="space-y-2">
        <h2 className="text-xl text-[var(--text-primary)]">Account responsibility</h2>
        <p>
      ...
      <section className="space-y-2">
        <h2 className="text-xl text-[var(--text-primary)]">Subscriptions</h2>
        <p>
