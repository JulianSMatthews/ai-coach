  ...
  return (
    ...
    >
      <section className="space-y-1.5">
        <h2 className="text-[15px] font-semibold text-[var(--text-primary)]">What we collect</h2>
        <p>
      ...
      <section className="space-y-1.5">
        <h2 className="text-[15px] font-semibold text-[var(--text-primary)]">How we use it</h2>
        <p>
      ...
      <section className="space-y-1.5">
        <h2 className="text-[15px] font-semibold text-[var(--text-primary)]">Service providers</h2>
        <p>
      ...
      <section className="space-y-1.5">
        <h2 className="text-[15px] font-semibold text-[var(--text-primary)]">Your choices</h2>
        <p>
