...
export default function LatestAssessmentPanel({
  ...
  const homeDockButtonClassName =
    "flex h-[4.5rem] min-w-0 flex-col items-center justify-center gap-1 rounded-[22px] border px-2 py-2 text-center transition focus:outline-none focus-visible:ring-2 focus-visible:ring-black focus-visible:ring-offset-2";
  ...
  const pillarTileClassName = "aspect-square rounded-[28px] border border-black px-3 py-3 text-left transition";
      ...
      {summaryPanelVisible ? (
        <div className="fixed inset-x-0 bottom-0 z-40 pointer-events-none">
          <div className="mx-auto w-full max-w-2xl px-4 pb-[calc(0.75rem+env(safe-area-inset-bottom))] sm:px-5">
            <div className="pointer-events-auto overflow-hidden rounded-[32px] border border-[#e7e1d6] bg-[#fffdf9] shadow-[0_18px_40px_-30px_rgba(30,27,22,0.35)]">
