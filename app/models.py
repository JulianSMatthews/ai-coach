...
class EducationProgramme(Base):
    ...
    marketing_video_script = Column(Text, nullable=True)
    marketing_video_url = Column(String(512), nullable=True)
    marketing_video_status = Column(String(32), nullable=True)
    marketing_video_job_id = Column(String(128), nullable=True)
    marketing_video_error = Column(Text, nullable=True)
    marketing_video_generated_at = Column(DateTime, nullable=True)
    marketing_video_payload_json = Column(JSONType, nullable=True)
    is_active = Column(Boolean, nullable=False, server_default=text("true"), index=True)
...
class EducationLessonVariant(Base):
    ...
    action_prompt = Column(Text, nullable=True)
    video_url = Column(String(512), nullable=True)
    poster_url = Column(String(512), nullable=True)
    avatar_character = Column(String(64), nullable=True)
    avatar_style = Column(String(96), nullable=True)
    avatar_voice = Column(String(128), nullable=True)
    ...
    avatar_summary_url = Column(String(512), nullable=True)
    avatar_payload_json = Column(JSONType, nullable=True)
