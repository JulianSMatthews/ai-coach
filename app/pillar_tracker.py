    ...
    *,
    ...
    return {
        "pillar": {
            ...
            "daily_quote": current_summary.get("daily_quote"),
            "daily_quote_generated": current_summary.get("daily_quote_generated"),
            "daily_quote_pending": current_summary.get("daily_quote_pending"),
            "completed_days_count": len(completed_days),
