...
def _supplement_education_programme(
    *,
    ...
    return {
        ...
        "is_active": True,
        "doc": {
            "title": f"HealthSense - {concept_label} Consistency Programme (4 Lessons)",
            "days": [
                {
                    "day_index": 1,
...
def _guided_concept_education_programme(
    *,
    ...
    return {
        ...
        "is_active": True,
        "doc": {
            "title": f"HealthSense - {concept_label} Education Programme (4 Lessons)",
            "days": [
                {
                    "day_index": 1,
...
BUILTIN_EDUCATION_PROGRAMMES: list[dict[str, Any]] = [
    {
        ...
        "is_active": True,
        "doc": {
            "title": "HealthSense - Fruit & Vegetable Education Programme (4 Lessons)",
            "days": [
                {
                    "day_index": 1,
    ...
    },
    {
        ...
        "is_active": True,
        "doc": {
            "title": "HealthSense - Hydration Education Programme (4 Lessons)",
            "days": [
                {
                    "day_index": 1,
    ...
    },
    {
        ...
        "is_active": True,
        "doc": {
            "title": "HealthSense - Protein Education Programme (4 Lessons)",
            "days": [
                {
                    "day_index": 1,
...
[
    {'pillar_key': 'training', 'concept_key': 'cardio_frequency', 'concept_label': 'Cardio frequency', 'code': 'cardio_frequency_awareness_4d', 'name': 'Cardio Awareness', 'level': 'build', 'pass_score_pct': 66.67, 'is_active': True, 'doc': {'title': 'HealthSense - Cardio Education Programme (4 Lessons)', 'days': [{'day_index': 1, 'title': 'Awareness: What Cardio Actually Is', 'summary': "Today you'll learn what cardio really means and why it's one of the most important drivers of long-term health.", 'questions': [{'text': 'What is cardio?', 'options': ['Only running', 'Any activity raising heart rate', 'Only gym workouts', 'Stretching'], 'correct': 'Any activity raising heart rate'}, {'text': 'What does cardio improve?', 'options': ['Hair growth', 'Heart and lung function', 'Height', 'Bone length'], 'correct': 'Heart and lung function'}, {'text': 'What is most important?', 'options': ['Intensity only', 'Consistency', 'Speed', 'Equipment'], 'correct': 'Consistency'}], 'script': "Today you'll learn what cardio really means and why it's one of the most important drivers of long-term health.\n\nCardio, or cardiovascular exercise, is any activity that raises your heart rate and improves the efficiency of your heart and lungs.\n\nThis includes walking, cycling, running, swimming, and even brisk daily movement.\n\nCardio improves:\n\n- heart health\n\n- circulation\n\n- energy levels\n\n- overall fitness\n\nResearch shows that regular cardiovascular activity reduces the risk of heart disease and improves longevity.\n\nThe key concept is not intensity - it's consistency.", 'action_prompt': 'Take a 10-minute brisk walk today.', 'takeaway': 'Cardio is any movement that raises your heart rate.'}, {'day_index': 2, 'title': "Why It's Hard: Consistency Over Intensity", 'summary': 'Yesterday you learned what cardio is.', 'questions': [{'text': 'What is a common mistake?', 'options': ['Doing too much', 'Thinking cardio must be intense', 'Walking too much', 'Drinking water'], 'correct': 'Thinking cardio must be intense'}, {'text': 'What matters more?', 'options': ['Intensity', 'Consistency', 'Equipment', 'Location'], 'correct': 'Consistency'}, {'text': 'Why do people stop?', 'options': ['Too easy', 'Too time-consuming or difficult', 'Too short', 'Too fun'], 'correct': 'Too time-consuming or difficult'}], 'script': "Yesterday you learned what cardio is. Today you'll understand why people struggle to stay consistent.\n\nMany people think cardio must be intense to be effective. This creates a barrier to starting.\n\nIn reality, moderate intensity done regularly is far more effective than occasional intense workouts.\n\nTime, motivation, and energy are common barriers.\n\nThe key is making cardio simple and repeatable.", 'action_prompt': 'Schedule one short cardio session (10-20 minutes) in your day.', 'takeaway': 'Consistency beats intensity.'}, {'day_index': 3, 'title': "What It's Doing: Heart, Energy & Fitness", 'summary': "Today you'll learn how cardio affects your body.", 'questions': [{'text': 'What happens to heart efficiency?', 'options': ['Decreases', 'Improves', 'Stops', 'No change'], 'correct': 'Improves'}, {'text': 'What happens to resting heart rate?', 'options': ['Increases', 'Decreases', 'Doubles', 'No effect'], 'correct': 'Decreases'}, {'text': 'What does cardio improve?', 'options': ['Fatigue', 'Endurance', 'Height', 'Hair'], 'correct': 'Endurance'}], 'script': "Today you'll learn how cardio affects your body.\n\nCardio strengthens your heart, allowing it to pump blood more efficiently.\n\nThis reduces resting heart rate and improves endurance.\n\nIt also improves oxygen delivery, meaning you feel less fatigued during daily tasks.\n\nOver time, cardio increases your fitness level and resilience.", 'action_prompt': 'Notice your breathing and effort during activity today.', 'takeaway': 'Cardio improves heart health and energy.'}, {'day_index': 4, 'title': 'What To Do: Simple Cardio Plan', 'summary': "Now it's about building a simple cardio routine.", 'questions': [{'text': 'Best cardio plan?', 'options': ['Once per week', 'Regular moderate sessions', 'Only intense workouts', 'No plan'], 'correct': 'Regular moderate sessions'}, {'text': 'What should you track?', 'options': ['Speed only', 'Consistency', 'Calories only', 'Distance only'], 'correct': 'Consistency'}, {'text': 'Ideal approach?', 'options': ['Extreme effort', 'Enjoyable and repeatable', 'Random', 'Rare'], 'correct': 'Enjoyable and repeatable'}], 'script': "Now it's about building a simple cardio routine.\n\nYou don't need long sessions - just regular movement.\n\nA simple approach:\n\n- 20-30 minutes most days\n\n- mix walking, cycling, or other enjoyable activities\n\n- keep intensity moderate\n\nTrack consistency rather than perfection.", 'action_prompt': 'Plan your next 3 cardio sessions for the week.', 'takeaway': 'Consistency builds long-term fitness.'}]}},
    {'pillar_key': 'training', 'concept_key': 'flexibility_mobility', 'concept_label': 'Flexibility & mobility', 'code': 'flexibility_mobility_awareness_4d', 'name': 'Mobility Awareness', 'level': 'build', 'pass_score_pct': 66.67, 'is_active': True, 'doc': {'title': 'HealthSense - Mobility Education Programme (4 Lessons)', 'days': [{'day_index': 1, 'title': 'Awareness: What Mobility Is', 'summary': "Today you'll learn what mobility actually is and why it's essential for how your body moves and feels every day.", 'questions': [{'text': 'What is mobility?', 'options': ['Stretching only', 'Controlled range of motion', 'Running', 'Strength only'], 'correct': 'Controlled range of motion'}, {'text': 'What does mobility support?', 'options': ['Posture and movement', 'Height', 'Hair growth', 'Sleep only'], 'correct': 'Posture and movement'}, {'text': 'Is mobility just flexibility?', 'options': ['Yes', 'No', 'Only for athletes', 'Only for injury'], 'correct': 'No'}], 'script': "Today you'll learn what mobility actually is and why it's essential for how your body moves and feels every day.\n\nMobility is your ability to move a joint through its full range of motion with control. It combines flexibility, strength, and coordination.\n\nGood mobility supports:\n\n- movement quality\n\n- injury prevention\n\n- posture\n\n- long-term joint health\n\nMobility is not just stretching. It's about controlled movement and stability.", 'action_prompt': 'Perform 5 minutes of simple joint movements (hips, shoulders, ankles).', 'takeaway': 'Mobility is controlled movement, not just stretching.'}, {'day_index': 2, 'title': "Why It's Hard: Sitting & Modern Lifestyle", 'summary': 'Yesterday you learned what mobility is.', 'questions': [{'text': 'What reduces mobility most?', 'options': ['Exercise', 'Sitting', 'Walking', 'Sleeping'], 'correct': 'Sitting'}, {'text': "What happens when joints aren't used?", 'options': ['Improve', 'Lose range', 'Grow stronger', 'No change'], 'correct': 'Lose range'}, {'text': 'Why do people lose mobility?', 'options': ['Too active', 'Lack of movement', 'Too much sleep', 'Diet'], 'correct': 'Lack of movement'}], 'script': "Yesterday you learned what mobility is. Today you'll understand why it declines.\n\nModern lifestyles involve long periods of sitting, reducing joint movement and causing stiffness.\n\nWhen joints are not used, they lose range of motion and strength.\n\nThis leads to tight hips, stiff backs, and reduced movement quality.", 'action_prompt': 'Stand up and move for 2-3 minutes every hour today.', 'takeaway': 'Lack of movement drives stiffness and loss of mobility.'}, {'day_index': 3, 'title': "What It's Doing: Movement & Injury Risk", 'summary': "Today you'll learn how mobility affects your body.", 'questions': [{'text': 'What happens with poor mobility?', 'options': ['Better movement', 'Compensation patterns', 'Faster recovery', 'No effect'], 'correct': 'Compensation patterns'}, {'text': 'What does mobility reduce?', 'options': ['Strength', 'Injury risk', 'Energy', 'Sleep'], 'correct': 'Injury risk'}, {'text': 'What improves with good mobility?', 'options': ['Movement efficiency', 'Hair', 'Height', 'Weight'], 'correct': 'Movement efficiency'}], 'script': "Today you'll learn how mobility affects your body.\n\nPoor mobility leads to compensations - where other parts of the body take over movement.\n\nThis increases stress on joints and raises injury risk.\n\nGood mobility allows efficient movement, better performance, and reduced discomfort.", 'action_prompt': 'Notice any tight or restricted area during movement today.', 'takeaway': 'Mobility supports efficient, safe movement.'}, {'day_index': 4, 'title': 'What To Do: Simple Mobility Routine', 'summary': "Now it's about action.", 'questions': [{'text': 'Best approach?', 'options': ['Long sessions only', 'Short consistent practice', 'Random stretching', 'No movement'], 'correct': 'Short consistent practice'}, {'text': 'What areas to focus on?', 'options': ['Hands only', 'Hips, shoulders, spine', 'Feet only', 'Neck only'], 'correct': 'Hips, shoulders, spine'}, {'text': 'What matters most?', 'options': ['Intensity', 'Consistency', 'Speed', 'Equipment'], 'correct': 'Consistency'}], 'script': "Now it's about action.\n\nMobility doesn't require long sessions - just consistent practice.\n\nSimple approach:\n\n- 5-10 minutes daily\n\n- focus on hips, shoulders, spine\n\n- controlled movements, not passive stretching\n\nConsistency improves movement and reduces stiffness.", 'action_prompt': 'Complete a 5-minute mobility routine today.', 'takeaway': 'Small daily movement improves long-term mobility.'}]}},
    {'pillar_key': 'training', 'concept_key': 'strength_training', 'concept_label': 'Strength training', 'code': 'strength_training_awareness_4d', 'name': 'Strength Training Awareness', 'level': 'build', 'pass_score_pct': 66.67, 'is_active': True, 'doc': {'title': 'HealthSense - Strength Training Education Programme (4 Lessons)', 'days': [{'day_index': 1, 'title': 'Awareness: What Strength Training Is', 'summary': "Today you'll learn what strength training actually is and why it's essential for long-term health, not just muscle building.", 'questions': [{'text': 'What is strength training?', 'options': ['Only lifting heavy weights', 'Any resistance-based exercise', 'Only gym workouts', 'Stretching'], 'correct': 'Any resistance-based exercise'}, {'text': 'What does strength training support?', 'options': ['Only appearance', 'Muscle and bone health', 'Height', 'Hydration'], 'correct': 'Muscle and bone health'}, {'text': 'What happens without strength training?', 'options': ['Muscle increases', 'Muscle loss over time', 'Faster metabolism', 'Increased flexibility'], 'correct': 'Muscle loss over time'}], 'script': "Today you'll learn what strength training actually is and why it's essential for long-term health, not just muscle building.\n\nStrength training involves using resistance to create muscular contraction. This can include weights, bodyweight exercises, or resistance bands.\n\nIt supports:\n\n- muscle mass\n\n- bone density\n\n- metabolism\n\n- joint stability\n\nAs we age, we naturally lose muscle - a process called sarcopenia. Strength training helps prevent this and maintain functional ability.\n\nThe key is not lifting heavy - it's applying resistance consistently.", 'action_prompt': 'Identify one simple strength exercise you can do (e.g. squats, press-ups).', 'takeaway': 'Strength training is essential for maintaining muscle and function.'}, {'day_index': 2, 'title': "Why It's Hard: Misconceptions & Barriers", 'summary': 'Yesterday you learned what strength training is.', 'questions': [{'text': 'What is a common misconception?', 'options': ['It requires heavy weights', 'It improves health', 'It builds strength', 'It takes time'], 'correct': 'It requires heavy weights'}, {'text': 'What is a barrier?', 'options': ['Lack of knowledge', 'Too easy', 'Too short', 'Too fun'], 'correct': 'Lack of knowledge'}, {'text': 'What is effective?', 'options': ['Complex routines', 'Simple consistent exercises', 'No movement', 'Random effort'], 'correct': 'Simple consistent exercises'}], 'script': "Yesterday you learned what strength training is. Today you'll understand why many people avoid it.\n\nCommon misconceptions include:\n\n- needing a gym\n\n- needing heavy weights\n\n- risk of injury\n\nIn reality, simple bodyweight exercises are effective and safe when done correctly.\n\nAnother barrier is not knowing where to start.\n\nThe key is simplicity and progression.", 'action_prompt': 'Try one set of a basic movement (e.g. 10 squats or wall push-ups).', 'takeaway': 'Strength training can be simple and accessible.'}, {'day_index': 3, 'title': "What It's Doing: Muscle, Metabolism & Resilience", 'summary': "Today you'll learn what strength training does inside your body.", 'questions': [{'text': 'What does muscle support?', 'options': ['Only strength', 'Metabolism and function', 'Hydration', 'Sleep only'], 'correct': 'Metabolism and function'}, {'text': 'What does strength training improve?', 'options': ['Injury risk', 'Reduces injury risk', 'Height', 'Hair'], 'correct': 'Reduces injury risk'}, {'text': 'What else improves?', 'options': ['Only muscle', 'Physical resilience', 'Vision', 'Hearing'], 'correct': 'Physical resilience'}], 'script': "Today you'll learn what strength training does inside your body.\n\nIt builds and maintains muscle, which supports metabolism and daily function.\n\nMore muscle means:\n\n- better glucose control\n\n- improved posture\n\n- reduced injury risk\n\nStrength training also improves resilience - both physically and mentally.", 'action_prompt': 'Notice how your body feels after doing a simple strength movement today.', 'takeaway': 'Strength training supports metabolism and resilience.'}, {'day_index': 4, 'title': 'What To Do: Simple Strength Plan', 'summary': "Now it's about building a simple, repeatable plan.", 'questions': [{'text': 'Best approach?', 'options': ['One long session', 'Regular short sessions', 'Random training', 'No plan'], 'correct': 'Regular short sessions'}, {'text': 'How often?', 'options': ['Once a month', '2-3 times per week', 'Every hour', 'Never'], 'correct': '2-3 times per week'}, {'text': 'What to focus on?', 'options': ['Complex exercises', 'Basic movements', 'Only machines', 'Only cardio'], 'correct': 'Basic movements'}], 'script': "Now it's about building a simple, repeatable plan.\n\nYou don't need long sessions - just consistency.\n\nA simple approach:\n\n- 2-3 sessions per week\n\n- focus on basic movements (push, pull, squat)\n\n- gradual progression\n\nBuild around:\n\n- squats\n\n- push-ups\n\n- pulling movements\n\nTrack consistency, not perfection.", 'action_prompt': 'Plan 2 short strength sessions this week.', 'takeaway': 'Consistency builds strength over time.'}]}},
    {'pillar_key': 'recovery', 'concept_key': 'bedtime_consistency', 'concept_label': 'Bedtime consistency', 'code': 'bedtime_consistency_awareness_4d', 'name': 'Regular Bedtime Awareness', 'level': 'build', 'pass_score_pct': 66.67, 'is_active': True, 'doc': {'title': 'HealthSense - Regular Bedtime Education Programme (4 Lessons)', 'days': [{'day_index': 1, 'title': 'Awareness: Why Regular Bedtime Matters', 'summary': "Today you'll learn why going to bed at a consistent time is one of the most powerful ways to improve sleep quality and overall health.", 'questions': [{'text': 'What controls your sleep timing?', 'options': ['Digestion', 'Circadian rhythm', 'Muscle system', 'Hydration'], 'correct': 'Circadian rhythm'}, {'text': 'What does a regular bedtime improve?', 'options': ['Only duration', 'Sleep quality and onset', 'Height', 'Hair'], 'correct': 'Sleep quality and onset'}, {'text': 'What happens with irregular bedtimes?', 'options': ['Better sleep', 'Disrupted sleep rhythm', 'Faster recovery', 'More energy'], 'correct': 'Disrupted sleep rhythm'}], 'script': "Today you'll learn why going to bed at a consistent time is one of the most powerful ways to improve sleep quality and overall health.\n\nYour body operates on an internal clock called the circadian rhythm. This regulates when you feel alert and when you feel sleepy.\n\nWhen you go to bed at the same time each night, your body learns when to prepare for sleep. This improves both how quickly you fall asleep and the quality of your sleep.\n\nIrregular bedtimes confuse this system, making sleep less efficient even if total sleep time is similar.", 'action_prompt': 'Note your bedtime tonight and compare it to the previous night.', 'takeaway': 'Consistency in bedtime improves sleep quality.'}, {'day_index': 2, 'title': "Why It's Hard: Lifestyle Disruption", 'summary': 'Yesterday you learned why regular bedtime matters.', 'questions': [{'text': 'What disrupts regular bedtime?', 'options': ['Exercise', 'Screens and routine changes', 'Water intake', 'Walking'], 'correct': 'Screens and routine changes'}, {'text': 'How much shift affects sleep?', 'options': ['None', '1-2 hours', '5 minutes', '10 hours'], 'correct': '1-2 hours'}, {'text': 'Why do people struggle?', 'options': ['Too easy', 'Inconsistent routines', 'Too much sleep', 'Diet'], 'correct': 'Inconsistent routines'}], 'script': "Yesterday you learned why regular bedtime matters. Today you'll understand why it's difficult to maintain.\n\nModern routines disrupt consistency:\n\n- late work\n\n- screen use\n\n- social habits\n\n- inconsistent schedules\n\nThese shift your sleep timing and delay your natural sleep signals.\n\nEven small shifts of 1-2 hours can impact how rested you feel.", 'action_prompt': 'Set a target bedtime for tonight within a 30-minute window.', 'takeaway': 'Small inconsistencies can disrupt sleep rhythm.'}, {'day_index': 3, 'title': "What It's Doing: Energy & Recovery", 'summary': "Today you'll learn how regular bedtime affects how you feel.", 'questions': [{'text': 'What improves with regular bedtime?', 'options': ['Sleep efficiency', 'Height', 'Hair', 'Weight only'], 'correct': 'Sleep efficiency'}, {'text': 'What does irregular sleep cause?', 'options': ['Better recovery', 'Fatigue and poor focus', 'More energy', 'Faster sleep'], 'correct': 'Fatigue and poor focus'}, {'text': 'What does regular sleep support?', 'options': ['Hormones and recovery', 'Only rest', 'Hydration', 'Digestion'], 'correct': 'Hormones and recovery'}], 'script': "Today you'll learn how regular bedtime affects how you feel.\n\nWhen you sleep at consistent times, your body enters deeper sleep more efficiently. This improves recovery, hormone regulation, and energy levels.\n\nIrregular sleep reduces sleep efficiency, meaning you may spend time in bed but not get quality rest.\n\nThis leads to:\n\n- fatigue\n\n- reduced focus\n\n- increased stress", 'action_prompt': 'Notice how you feel after consistent vs inconsistent sleep timing.', 'takeaway': 'Regular timing improves sleep quality and energy.'}, {'day_index': 4, 'title': 'What To Do: Build a Consistent Bedtime', 'summary': "Now it's about building a consistent bedtime routine.", 'questions': [{'text': 'Best approach?', 'options': ['Random bedtimes', 'Consistent window', 'Late nights', 'No routine'], 'correct': 'Consistent window'}, {'text': 'What helps bedtime consistency?', 'options': ['Wind-down routine', 'Screens', 'Noise', 'Light'], 'correct': 'Wind-down routine'}, {'text': 'What matters most?', 'options': ['Perfection', 'Consistency', 'Speed', 'Effort'], 'correct': 'Consistency'}], 'script': "Now it's about building a consistent bedtime routine.\n\nSimple approach:\n\n- choose a realistic bedtime\n\n- stick within a 30-minute window\n\n- build a wind-down routine before bed\n\nStart small - consistency matters more than perfection.\n\nOver time, your body will naturally align with this rhythm, making sleep easier and more restorative.", 'action_prompt': 'Set a fixed bedtime window for the next 3 nights.', 'takeaway': 'Regular bedtime builds better sleep naturally.'}]}},
    {'pillar_key': 'recovery', 'concept_key': 'sleep_duration', 'concept_label': 'Sleep duration', 'code': 'sleep_duration_awareness_4d', 'name': 'Sleep Duration Awareness', 'level': 'build', 'pass_score_pct': 66.67, 'is_active': True, 'doc': {'title': 'HealthSense - Sleep Duration Education Programme (4 Lessons)', 'days': [{'day_index': 1, 'title': 'Awareness: Why Sleep Duration Matters', 'summary': "Today you'll learn why sleep duration is one of the most important drivers of health, performance, and recovery.", 'questions': [{'text': 'What is the primary role of sleep?', 'options': ['Entertainment', 'Recovery and restoration', 'Digestion', 'Hydration'], 'correct': 'Recovery and restoration'}, {'text': 'How much sleep do most adults need?', 'options': ['4-5 hours', '7-9 hours', '10-12 hours', '3 hours'], 'correct': '7-9 hours'}, {'text': 'What does lack of sleep affect?', 'options': ['Only energy', 'Energy, focus, mood', 'Height', 'Hair'], 'correct': 'Energy, focus, mood'}], 'script': "Today you'll learn why sleep duration is one of the most important drivers of health, performance, and recovery.\n\nSleep is when your body restores itself - physically and mentally. During sleep, your body repairs tissue, regulates hormones, and consolidates memory.\n\nMost adults need around 7-9 hours of sleep per night, although individual needs vary.\n\nEven small reductions in sleep can impact:\n\n- energy\n\n- focus\n\n- mood\n\n- decision-making\n\nSleep is not a luxury - it's a foundation.", 'action_prompt': 'Track how many hours you sleep tonight.', 'takeaway': 'Sleep duration is a core pillar of health.'}, {'day_index': 2, 'title': "Why It's Hard: Modern Disruption", 'summary': 'Yesterday you learned how important sleep is.', 'questions': [{'text': 'What disrupts sleep most?', 'options': ['Exercise', 'Screens and late routines', 'Water intake', 'Walking'], 'correct': 'Screens and late routines'}, {'text': 'What is the circadian rhythm?', 'options': ['Digestion cycle', 'Internal body clock', 'Muscle system', 'Breathing pattern'], 'correct': 'Internal body clock'}, {'text': 'What happens with disruption?', 'options': ['Better sleep', 'Harder to sleep', 'Faster recovery', 'More energy'], 'correct': 'Harder to sleep'}], 'script': "Yesterday you learned how important sleep is. Today you'll understand why it's often disrupted.\n\nModern life works against sleep:\n\n- screens and blue light\n\n- late meals\n\n- stress\n\n- inconsistent schedules\n\nThese disrupt your body's internal clock, known as the circadian rhythm.\n\nWhen this rhythm is disrupted, it becomes harder to fall asleep and stay asleep.", 'action_prompt': 'Avoid screens for 30 minutes before bed tonight.', 'takeaway': 'Modern habits disrupt natural sleep rhythms.'}, {'day_index': 3, 'title': "What It's Doing: Energy, Hormones & Recovery", 'summary': "Today you'll learn how sleep duration affects your body.", 'questions': [{'text': 'What does poor sleep increase?', 'options': ['Muscle growth', 'Hunger and cravings', 'Hydration', 'Flexibility'], 'correct': 'Hunger and cravings'}, {'text': 'What does sleep support?', 'options': ['Only rest', 'Recovery and hormones', 'Height', 'Hair'], 'correct': 'Recovery and hormones'}, {'text': 'What happens to energy with poor sleep?', 'options': ['Increases', 'Decreases', 'No change', 'Doubles'], 'correct': 'Decreases'}], 'script': "Today you'll learn how sleep duration affects your body.\n\nSleep impacts hormones that regulate hunger and energy, including ghrelin and leptin.\n\nLack of sleep increases hunger and cravings, particularly for high-calorie foods.\n\nIt also affects recovery, immune function, and mental performance.\n\nPoor sleep = higher stress, lower energy, and reduced resilience.", 'action_prompt': 'Notice how your energy and cravings feel after different sleep durations.', 'takeaway': 'Sleep directly affects hormones, energy, and recovery.'}, {'day_index': 4, 'title': 'What To Do: Improve Sleep Duration', 'summary': "Now it's about building a simple approach to better sleep.", 'questions': [{'text': 'Best sleep strategy?', 'options': ['Random sleep times', 'Consistent schedule', 'Less sleep', 'Late nights'], 'correct': 'Consistent schedule'}, {'text': 'What helps sleep?', 'options': ['Bright lights', 'Dark cool room', 'Noise', 'Screens'], 'correct': 'Dark cool room'}, {'text': 'What is important?', 'options': ['Perfection', 'Consistency', 'Speed', 'Intensity'], 'correct': 'Consistency'}], 'script': "Now it's about building a simple approach to better sleep.\n\nFocus on consistency:\n\n- go to bed at the same time\n\n- wake up at the same time\n\n- create a wind-down routine\n\nSimple strategies:\n\n- reduce light before bed\n\n- keep your room cool and dark\n\n- avoid heavy meals late\n\nConsistency improves sleep quality and duration.", 'action_prompt': 'Set a consistent bedtime tonight.', 'takeaway': 'Consistency is key to improving sleep duration.'}]}},
    {'pillar_key': 'recovery', 'concept_key': 'sleep_quality', 'concept_label': 'Sleep quality', 'code': 'sleep_quality_awareness_4d', 'name': 'Sleep Quality Awareness', 'level': 'build', 'pass_score_pct': 66.67, 'is_active': True, 'doc': {'title': 'HealthSense - Sleep Quality Education Programme (4 Lessons)', 'days': [{'day_index': 1, 'title': 'Awareness: What Sleep Quality Means', 'summary': "Today you'll learn what sleep quality actually means and why it matters just as much as sleep duration.", 'questions': [{'text': 'What is sleep quality?', 'options': ['Time asleep only', 'How well you sleep', 'Sleep location', 'Sleep timing'], 'correct': 'How well you sleep'}, {'text': 'What happens during deep sleep?', 'options': ['Nothing', 'Recovery', 'Digestion only', 'Movement'], 'correct': 'Recovery'}, {'text': 'Can you feel tired after 8 hours sleep?', 'options': ['No', 'Yes, if quality is poor', 'Only sometimes', 'Never'], 'correct': 'Yes, if quality is poor'}], 'script': "Today you'll learn what sleep quality actually means and why it matters just as much as sleep duration.\n\nSleep quality refers to how well you sleep - not just how long. Good quality sleep means:\n\n- falling asleep easily\n\n- staying asleep\n\n- reaching deeper stages of sleep\n\nDeep sleep is where recovery happens - physically and mentally.\n\nEven if you sleep 7-8 hours, poor quality sleep can leave you feeling tired.", 'action_prompt': 'Rate your sleep quality this morning from 1-5.', 'takeaway': 'Sleep quality matters as much as duration.'}, {'day_index': 2, 'title': "Why It's Hard: Fragmented Sleep", 'summary': 'Yesterday you learned what sleep quality is.', 'questions': [{'text': 'What disrupts sleep quality?', 'options': ['Exercise', 'Light and noise', 'Water', 'Walking'], 'correct': 'Light and noise'}, {'text': 'What reduces deep sleep?', 'options': ['Consistency', 'Interruptions', 'Darkness', 'Quiet'], 'correct': 'Interruptions'}, {'text': 'Can you wake without remembering?', 'options': ['No', 'Yes', 'Only at night', 'Rarely'], 'correct': 'Yes'}], 'script': "Yesterday you learned what sleep quality is. Today you'll understand why it's often poor.\n\nSleep is often disrupted by:\n\n- stress\n\n- noise\n\n- light\n\n- temperature\n\n- late eating or alcohol\n\nThese interruptions reduce time spent in deep sleep.\n\nEven brief awakenings can reduce sleep quality without you remembering them.", 'action_prompt': 'Reduce one disruption tonight (light, noise, or temperature).', 'takeaway': 'Small disruptions reduce sleep quality.'}, {'day_index': 3, 'title': "What It's Doing: Recovery & Brain Function", 'summary': "Today you'll learn how sleep quality affects your body and mind.", 'questions': [{'text': 'What does good sleep support?', 'options': ['Only rest', 'Recovery and memory', 'Height', 'Hair'], 'correct': 'Recovery and memory'}, {'text': 'What does poor sleep cause?', 'options': ['More energy', 'Fatigue', 'Faster recovery', 'Strength gain'], 'correct': 'Fatigue'}, {'text': 'What else is affected?', 'options': ['Vision', 'Focus and resilience', 'Hearing', 'Taste'], 'correct': 'Focus and resilience'}], 'script': "Today you'll learn how sleep quality affects your body and mind.\n\nGood sleep quality supports:\n\n- memory consolidation\n\n- hormone balance\n\n- physical recovery\n\nPoor sleep quality leads to:\n\n- fatigue\n\n- poor focus\n\n- slower recovery\n\nIt also increases stress and reduces resilience.", 'action_prompt': "Notice your focus and energy today based on last night's sleep.", 'takeaway': 'Sleep quality drives recovery and mental performance.'}, {'day_index': 4, 'title': 'What To Do: Improve Sleep Quality', 'summary': "Now it's about improving sleep quality.", 'questions': [{'text': 'What improves sleep quality?', 'options': ['Bright light', 'Dark cool room', 'Noise', 'Screens'], 'correct': 'Dark cool room'}, {'text': 'What helps before bed?', 'options': ['Screens', 'Wind-down routine', 'Exercise', 'Work'], 'correct': 'Wind-down routine'}, {'text': 'What matters most?', 'options': ['Perfection', 'Consistency', 'Speed', 'Effort'], 'correct': 'Consistency'}], 'script': "Now it's about improving sleep quality.\n\nFocus on your environment:\n\n- dark room\n\n- cool temperature\n\n- minimal noise\n\nBuild a wind-down routine:\n\n- reduce screens\n\n- relax before bed\n\nConsistency improves both quality and duration.", 'action_prompt': 'Create a simple 10-minute wind-down routine tonight.', 'takeaway': 'Environment and routine improve sleep quality.'}]}}
]
)
...
BUILTIN_EDUCATION_PROGRAMMES.extend(
    [
        _guided_concept_education_programme(
            pillar_key="reflection",
            concept_key="self_awareness",
            concept_label="Self-Awareness",
            code="self_awareness_awareness_4d",
            name="Self-Awareness Awareness",
            opening_line="Today you'll learn how Self-Awareness helps you notice what you think, feel, and do before the day runs away from you.",
            concept_focus="The focus is a simple daily check-in. It makes reflection visible so you can spot what you did, what you noticed, and what you want to repeat or change.",
            tracking_answer="Reflection check-ins",
            why_hard="It often slips because the day is busy and there is no protected pause to step back.",
            friction_answer="No protected pause",
            support_answer="A short end-of-day cue",
            body_effect="A brief check-in can improve self-understanding and make your next choice more deliberate.",
            pattern_answer="Thoughts, actions, and choices",
            action_line="Take one minute tonight to write down one thing you learned about your day.",
            weekly_plan="Attach a short reflection to a routine you already do, such as after dinner or before bed.",
        ),
        _guided_concept_education_programme(
            pillar_key="reflection",
            concept_key="emotional_awareness",
            concept_label="Emotional Awareness",
            code="emotional_awareness_awareness_4d",
            name="Emotional Awareness",
            opening_line="Today you'll learn how Emotional Awareness helps you notice what you are feeling instead of only reacting to it.",
            concept_focus="The focus is naming the feeling plainly so the daily record shows when emotions were present and how they changed.",
            tracking_answer="Emotion check-ins",
            why_hard="It often slips because feelings are easy to overlook when the day is fast or stressful.",
            friction_answer="Rushing past feelings",
            support_answer="A simple feeling label",
            body_effect="Naming an emotion can reduce confusion and make it easier to choose a steadier next step.",
            pattern_answer="Feelings and triggers",
            action_line="Pause once today and name the main feeling you are carrying.",
            weekly_plan="Use a simple prompt like 'What am I feeling right now?' at one set point each day.",
        ),
        _guided_concept_education_programme(
            pillar_key="reflection",
            concept_key="mindfulness_presence",
            concept_label="Presence",
            code="mindfulness_presence_awareness_4d",
            name="Presence Awareness",
            opening_line="Today you'll learn how Presence helps you stay focused on what is happening now rather than drifting on autopilot.",
            concept_focus="The focus is attention. It tracks whether you were present for most of the day in a simple, honest way.",
            tracking_answer="Focused moments",
            why_hard="It often slips when attention is pulled by messages, multitasking, or a crowded schedule.",
            friction_answer="Constant distraction",
            support_answer="One single-task block",
            body_effect="Presence can reduce scatter and make everyday work, conversation, and decisions feel clearer.",
            pattern_answer="Attention and drift",
            action_line="Choose one task today and do it without switching away until it is done.",
            weekly_plan="Build one short single-task block into each day and protect it from interruptions.",
        ),
        _guided_concept_education_programme(
            pillar_key="reflection",
            concept_key="pattern_recognition",
            concept_label="Learning & Patterns",
            code="pattern_recognition_awareness_4d",
            name="Learning & Patterns Awareness",
            opening_line="Today you'll learn how Learning & Patterns helps you spot repeating behaviour instead of treating each day as separate.",
            concept_focus="The focus is noticing repeat signals so you can see what helps, what gets in the way, and what keeps happening.",
            tracking_answer="Pattern spotting",
            why_hard="It often slips because patterns only become visible after several days, not in one isolated moment.",
            friction_answer="Seeing only one day",
            support_answer="A weekly review",
            body_effect="Spotting patterns turns scattered experiences into useful information for your next decision.",
            pattern_answer="Repeat signals",
            action_line="Look back over the last three days and note one repeated pattern.",
            weekly_plan="Review your records once a week and look for one repeating trigger, routine, or outcome.",
        ),
        _guided_concept_education_programme(
            pillar_key="purpose",
            concept_key="meaning_fulfilment",
            concept_label="Meaning",
            code="meaning_fulfilment_awareness_4d",
            name="Meaning Awareness",
            opening_line="Today you'll learn how Meaning helps you notice whether the day felt worthwhile, not just busy.",
            concept_focus="The focus is whether the day connected to something that mattered to you in a real and ordinary way.",
            tracking_answer="Meaningful moments",
            why_hard="It often slips because busy days can feel full without feeling meaningful.",
            friction_answer="Busy without reflection",
            support_answer="A short end-of-day pause",
            body_effect="Noticing meaning can make your daily record more honest about what actually felt worthwhile.",
            pattern_answer="Meaning and fulfilment",
            action_line="Write down one moment today that felt worthwhile.",
            weekly_plan="End the day with one small question: what gave today meaning?",
        ),
        _guided_concept_education_programme(
            pillar_key="purpose",
            concept_key="direction_vision",
            concept_label="Direction",
            code="direction_vision_awareness_4d",
            name="Direction Awareness",
            opening_line="Today you'll learn how Direction helps you check whether your actions moved you toward what matters most.",
            concept_focus="The focus is forward movement. It shows whether the day helped you get closer to your priorities, even in a small way.",
            tracking_answer="Direction check-ins",
            why_hard="It often slips because it is easier to stay busy than to pause and compare the day with your priorities.",
            friction_answer="No clear next step",
            support_answer="A simple priority cue",
            body_effect="A direction check can make the next decision easier by linking effort to what matters.",
            pattern_answer="Actions and priorities",
            action_line="Choose one action today that clearly moves you toward what matters most.",
            weekly_plan="Start the morning by naming one priority and one small action that supports it.",
        ),
        _guided_concept_education_programme(
            pillar_key="purpose",
            concept_key="values_alignment",
            concept_label="Values",
            code="values_alignment_awareness_4d",
            name="Values Awareness",
            opening_line="Today you'll learn how Values helps you check whether what you did matched who you want to be.",
            concept_focus="The focus is alignment. It turns your values into something visible in the day, not just an idea in the background.",
            tracking_answer="Values-aligned actions",
            why_hard="It often slips because values are easiest to ignore when the day is reactive or rushed.",
            friction_answer="Reacting on autopilot",
            support_answer="A short values reminder",
            body_effect="Values alignment can reduce regret and make decisions feel more coherent.",
            pattern_answer="Values and action",
            action_line="Pick one moment today where you can act in line with a value you care about.",
            weekly_plan="Choose one value to notice each day and review whether your actions matched it.",
        ),
        _guided_concept_education_programme(
            pillar_key="purpose",
            concept_key="contribution_connection",
            concept_label="Contribution",
            code="contribution_connection_awareness_4d",
            name="Contribution Awareness",
            opening_line="Today you'll learn how Contribution helps you notice when you positively helped or connected with someone.",
            concept_focus="The focus is simple contribution: small actions that support, connect, or make life a little better for someone else.",
            tracking_answer="Helpful connections",
            why_hard="It often slips because contribution is easy to overlook when your own tasks fill the day.",
            friction_answer="Self-focus and hurry",
            support_answer="A planned connection moment",
            body_effect="Contribution can strengthen purpose by showing that your actions mattered to someone else.",
            pattern_answer="Help and connection",
            action_line="Do one small thing today that helps or connects with another person.",
            weekly_plan="Plan one small contribution each day and note what it changes for you and for others.",
        ),
    ]
)
