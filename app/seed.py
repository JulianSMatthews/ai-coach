...
DEFAULT_DAY_REOPEN_BODY = (
    "Hi {{1}}, {{2}} from CoachSense here. {{3}} Please tap the button below to continue your wellbeing journey."
)
...
DEFAULT_PROMPT_TEMPLATES = [
    {
        ...
        "task_block": """You are delivering the kick-off podcast for the CoachSense programme.
...
Reinforce the philosophy of CoachSense
...
Your role is to warmly welcome them, introduce the CoachSense approach, and help them understand that they can begin using their starter Habit Steps straight away while their officially chosen Habit Steps will begin on Sunday.
This message should feel calm, supportive, warm, and human.
Write in plain text only.
Do not use bold, italics, or formatting symbols.
Core Purpose
• Welcome them into CoachSense coaching.
...
Explain, in simple human language, that CoachSense works through:
...
Stay within the CoachSense coaching space.
...
When speaking about CoachSense:
...
- their overall CoachSense result
...
Return plain text only.""",
    ...
    },
    {
        ...
        "task_block": """You are a pragmatic health coach helping people translate CoachSense Scores into weekly habits.
...
def parse_education_programme_docx(path: str) -> dict[str, Any]:
    """
    Parse CoachSense education DOCX files that follow this convention:
    DAY n - Title
    Script:
    Questions:
    1. ...
...
def _supplement_education_programme(
    *,
    ...
    return {
        ...
        "is_active": True,
        "doc": {
            "title": f"CoachSense - {concept_label} Consistency Programme (4 Days)",
            "days": [
                {
                    "day_index": 1,
                    ...
                    "script": (
                        ...
                        f"{context_line}\n\n"
                        "CoachSense is tracking whether it was taken as planned, not recommending a dose or telling you whether you should take it.\n\n"
...
def _guided_concept_education_programme(
    *,
    ...
    return {
        ...
        "is_active": True,
        "doc": {
            "title": f"CoachSense - {concept_label} Education Programme (4 Days)",
            "days": [
                {
                    "day_index": 1,
                    ...
                    "questions": [
                        {
                            "text": f"What is CoachSense using {concept_label} to track?",
                ...
                },
                {
                    ...
                    "script": (
                        ...
                        f"{body_effect}\n\n"
                        "The record helps CoachSense review all concepts equally and decide what matters from the daily signals.\n\n"
...
BUILTIN_EDUCATION_PROGRAMMES: list[dict[str, Any]] = [
    {
        ...
        "is_active": True,
        "doc": {
            "title": "CoachSense - Fruit & Vegetable Education Programme (4 Days)",
            "days": [
                {
                    "day_index": 1,
    ...
    },
    {
        ...
        "is_active": True,
        "doc": {
            "title": "CoachSense - Hydration Education Programme (4 Days)",
            "days": [
                {
                    "day_index": 1,
    ...
    },
    {
        ...
        "is_active": True,
        "doc": {
            "title": "CoachSense - Processed Foods Education Programme (4 Days)",
            "days": [
                {
                    "day_index": 1,
    ...
    },
    {
        ...
        "is_active": True,
        "doc": {
            "title": "CoachSense - Protein Education Programme (4 Days)",
            "days": [
                {
                    "day_index": 1,
...
BUILTIN_EDUCATION_PROGRAMMES.extend(
    [
        ...
        _guided_concept_education_programme(
            ...
            opening_line="Today you'll learn how the ketogenic or low-carb setting gives CoachSense context for interpreting ketone signals.",
