...
def get_weekly_objectives_config(user_id: int) -> dict[str, Any]:
    pillars = [_objective_concepts_payload(int(user_id), pillar_key) for pillar_key in active_pillar_keys(user_id)]
...
def save_weekly_objectives_config(
    ...
    *,
    ...
    if section_key not in active_pillar_keys(user_id):
