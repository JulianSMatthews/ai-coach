        ...
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            ...
            <p className="mt-1 text-sm text-[#6b6257]">
              Use this when the app should open the insight in video first, with audio and reading available as secondary options.
            </p>
          </div>
          {!avatarGenerateAction ? (
            <p className="text-xs uppercase tracking-[0.2em] text-[#6b6257]">Save content first to generate</p>
          ) : null}
        </div>
