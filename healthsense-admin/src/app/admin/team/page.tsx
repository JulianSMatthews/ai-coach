  ...
  return (
    <main className="min-h-screen bg-[#f7f4ee] px-6 py-10 text-[#1e1b16]">
      <div className="mx-auto w-full max-w-6xl space-y-6">
        <AdminNav title="Team" subtitle="Manage internal team OKRs and role access." />
        ...
        <section className="grid gap-4 md:grid-cols-2">
          ...
          <article className="rounded-3xl border border-[#e7e1d6] bg-white p-6">
            <p className="text-xs uppercase tracking-[0.2em] text-[#6b6257]">Role section</p>
            <h2 className="mt-3 text-xl font-semibold">Team roles</h2>
            <p className="mt-2 text-sm text-[#6b6257]">
              Set access roles for staff members in HS Admin.
            </p>
            <Link
